...
class Weapon(Item):
    ...
    def use(self):
       pass
    def from_json(weapon):
        return json.loads(weapon)
...
class Inventory:
    ...
    def to_json(self):
        return json.dumps(self.inventory, default=vars, indent=2)
...
long_bow_to = long_bow.to_json()
print(long_bow_to)
print(type(long_bow_to))
long_bow_string = '{"name": "Belthronding", "damage": 500, "type": "bow", "rarity": "legendary", "equipped": "False", "description": "A long and very powerful sword", "owner": "cj", "string": "The special move slash is used", "ownership": "cj"}'
long_bow_from = Single_handed.from_json(long_bow_string)
print(long_bow_from)
print(type(long_bow_from))